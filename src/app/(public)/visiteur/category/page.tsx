...
export default function VisiteurMarketplacePage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen w-full overflow-hidden bg-[#F8F9FB] -m-6 md:-m-8">
      ...
      <aside className="w-full lg:w-70 lg:flex-shrink-0 bg-white border-b lg:border-b-0 lg:border-r border-neutral-200 lg:h-full flex flex-col z-30">
        ...
        {/* En-tête Sidebar + Recherche catégories */}
      ...
      <main className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        {/* Défilement produits */}
        <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 pb-32 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
