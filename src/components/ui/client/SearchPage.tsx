...
export default async function SearchPage({ query }: { query: string }) {
    ...
    return (
        <LocationProvider>
            ...
            <div className="fixed top-2 z-30 border border-app-secondary/20 p-5 md:p-6 rounded-2xl md:rounded-3xl bg-app-card shadow-sm w-6/7 md:w-4/6">
                <div className="flex justify-between items-start mb-1">
                    <p className="text-xs md:text-sm text-app-secondary font-medium">
                        Recherche de matériaux
                    </p>
                </div>
                {query ? (
                    <div className="flex flex-row md:items-end justify-between gap-2">
